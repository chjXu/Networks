...
def main():
    ...
    tb_writer = SummaryWriter(log_dir='./flower')
    ...
    data_root = os.path.abspath(os.path.join(os.getcwd(), "/media/xuchengjun/D/"))  # get data root path
    ...
    for epoch in range(epochs):
        ...
        for step, data in enumerate(train_bar):
            images, labels = data
            optimizer.zero_grad()
            outputs, aux_logits2, aux_logits1 = net(images.to(device))
